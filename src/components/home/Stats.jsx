...
import { StaggerList, StaggerItem } from "@/components/common/Animate";
...
export function Stats() {
  return (
    <section className="bg-navy py-12 text-white">
      <StaggerList className="mx-auto grid max-w-7xl grid-cols-2 gap-6 px-6 md:grid-cols-4 md:gap-8">
        {stats.map((s) => (
