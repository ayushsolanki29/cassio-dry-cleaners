        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            ...
            <h2 className="font-display text-4xl font-semibold leading-tight md:text-5xl lg:text-6xl">
              Ready to partner with Cassio?
            </h2>
            <p className="text-lg text-white/85 lg:text-xl">
              Let's discuss how Cassio Dry Cleaners can support your business with professional laundry solutions. Reliable service for hotels, restaurants, gyms, and offices.
            </p>
          ...
          <div className="relative">
            <div className="relative overflow-hidden rounded-3xl">
              <img
                ...
                alt="Cassio business partnership and commercial services"
            ...
            <div className="absolute -right-4 -top-4 rounded-2xl bg-white/90 p-4 shadow-pop backdrop-blur-sm">
              <div className="text-center">
                <p className="font-display text-2xl font-bold text-brand">B2B</p>
                <p className="text-xs text-navy">Solutions</p>
              </div>
            </div>
            
            <div className="absolute -bottom-4 -left-4 rounded-2xl bg-white/90 p-4 shadow-pop backdrop-blur-sm">
              <div className="text-center">
                <p className="font-display text-2xl font-bold text-sun">24/7</p>
                <p className="text-xs text-navy">Support</p>
              </div>
            </div>
          </div>
        </div>
