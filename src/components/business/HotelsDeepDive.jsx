...
export function HotelsDeepDive() {
  return (
    <section className="bg-cream py-16">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid items-center gap-10 lg:grid-cols-2">
          <div>
            <span className="text-sm font-semibold uppercase tracking-wider text-brand">Hotels & Hospitality</span>
            <h2 className="mt-3 font-display text-4xl font-semibold text-navy md:text-5xl">
              Premium service for hotel guests
            </h2>
            <p className="mt-4 text-lg text-muted-foreground">
              Cassio Dry Cleaners understands the hospitality industry. We provide reliable, high-quality laundry services that keep your hotel running smoothly and your guests satisfied.
            </p>
          ...
          <div className="relative">
            ...
            <img
              ...
              alt="Cassio hotel laundry services"
